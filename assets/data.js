...
const SITE_DATA = {
  ...
  bio: {
    positioning:
      "Graphic Designer with 4+ years of experience and Product Designer with 2+ years of experience.",
    body:
      "Experience across brand identity, marketing creatives, social media, UI/UX, product design, websites, and AI-assisted design and development — working with startups, founders, developers, agencies, NGOs, and international clients.",
  },

  services: [
    { n: "01", title: "Brand Identity", blurb: "Logos, colour systems and guidelines that give a brand a consistent look everywhere it shows up.", img: "https://res.cloudinary.com/dk1kmgcqn/image/upload/v1789236092/1_rlq3m2.png" },
    { n: "02", title: "Social Media Design", blurb: "Story, post and campaign creatives built to stop the scroll and stay on-brand across every platform.", img: "https://res.cloudinary.com/dk1kmgcqn/image/upload/v1789236093/2_znvxpx.png" },
    { n: "03", title: "Marketing Creatives", blurb: "Ad creatives and promotional assets designed to convert across web, social and print.", img: "https://res.cloudinary.com/dk1kmgcqn/image/upload/v1789236094/3_j7l5ld.png" },
    { n: "04", title: "Posters & Banners", blurb: "Event, campaign and web banners that grab attention in a single glance.", img: "https://res.cloudinary.com/dk1kmgcqn/image/upload/v1789236094/4_vdjb6o.png" },
    { n: "05", title: "UI/UX Design", blurb: "User flows, wireframes and high-fidelity interfaces built end-to-end in Figma.", img: "https://res.cloudinary.com/dk1kmgcqn/image/upload/v1789236095/6_r2pqqm.png" },
    { n: "06", title: "Print & Packaging Design", blurb: "Print-ready collateral and packaging design that holds up off the screen too.", img: "https://res.cloudinary.com/dk1kmgcqn/image/upload/v1789236095/7_i4utnp.png" },
    { n: "07", title: "AI-Assisted Design & Development", blurb: "Prompt-driven workflows that take an idea from concept to a working, shippable build.", img: "https://res.cloudinary.com/dk1kmgcqn/image/upload/v1789236095/5_cdxw8t.png" },
  ],
