...
const SERVICES = [
  ...
  { id:'webdev', icon:'code', title:'Website Development',
    ...
    count:'5+ Sites Shipped', world:'webdev', modal:'showcase' },
  ...
  { id:'aivideo', icon:'video', title:'AI Video Generation',
    desc:'Cartoon, UGC-style and product AI videos generated end-to-end with AI tools.',
    count:'13+ AI Videos', world:'vibe', modal:'video' }
];
...
const WEBDEV_PROJECTS = [
  { name:'The Social Bling', desc:'Multi-page site for a digital marketing agency, with a dynamic filterable blog and SEO-structured pages.', tech:['HTML','CSS','JavaScript'], url:'https://thesocialbling.com/', live:true, gradient:'linear-gradient(135deg,#0A1B2E,#F2A623)', img:'assets/images/social-bling-hero.jpg' },
...
/* ============ AI VIDEOS DATA ============
   Each video's card auto-sizes to that video's own width/height (masonry
   layout, no forced crop) — so a portrait UGC clip and a landscape cartoon
   clip can sit side by side without either one being stretched.
   HOW TO ADD MORE: add another entry below with title, category, src (video
   URL or local path under assets/videos/ai-work/), and poster (thumbnail).
   Poster here uses Cloudinary's automatic video-thumbnail transform
   (so_0 = grab frame at 0s, .jpg output) so no separate thumbnail upload
   is needed for Cloudinary-hosted clips. */
const AI_VIDEOS = [
  { title:'AI Cartoon Video 1', category:'Cartoon', src:'https://res.cloudinary.com/dk1kmgcqn/video/upload/v1785065957/next_czpuon.mp4', poster:'https://res.cloudinary.com/dk1kmgcqn/video/upload/so_0/v1785065957/next_czpuon.jpg' },
  { title:'AI Cartoon Video 2', category:'Cartoon', src:'https://res.cloudinary.com/dk1kmgcqn/video/upload/v1785065960/Create_an_exactly_second_HO_4_lynh9q.mp4', poster:'https://res.cloudinary.com/dk1kmgcqn/video/upload/so_0/v1785065960/Create_an_exactly_second_HO_4_lynh9q.jpg' },
  { title:'AI Cartoon Video 3', category:'Cartoon', src:'https://res.cloudinary.com/dk1kmgcqn/video/upload/v1785065959/Create_an_exactly_second_HO_5_zldub6.mp4', poster:'https://res.cloudinary.com/dk1kmgcqn/video/upload/so_0/v1785065959/Create_an_exactly_second_HO_5_zldub6.jpg' },
  { title:'AI Cartoon Video 4', category:'Cartoon', src:'https://res.cloudinary.com/dk1kmgcqn/video/upload/v1785065960/Create_an_exactly_second_VE_ftdlzg.mp4', poster:'https://res.cloudinary.com/dk1kmgcqn/video/upload/so_0/v1785065960/Create_an_exactly_second_VE_ftdlzg.jpg' },
  { title:'AI Cartoon Video 5', category:'Cartoon', src:'https://res.cloudinary.com/dk1kmgcqn/video/upload/v1785065971/Create_an_exactly_second_VE_8_q0fbtd.mp4', poster:'https://res.cloudinary.com/dk1kmgcqn/video/upload/so_0/v1785065971/Create_an_exactly_second_VE_8_q0fbtd.jpg' },
  { title:'AI Cartoon Video 6', category:'Cartoon', src:'https://res.cloudinary.com/dk1kmgcqn/video/upload/v1785065999/Create_an_exactly_second_VE_7_wecl3f.mp4', poster:'https://res.cloudinary.com/dk1kmgcqn/video/upload/so_0/v1785065999/Create_an_exactly_second_VE_7_wecl3f.jpg' },
  { title:'AI Cartoon Video 7', category:'Cartoon', src:'https://res.cloudinary.com/dk1kmgcqn/video/upload/v1785066001/Create_an_exactly_second_HO_3_kwpfu2.mp4', poster:'https://res.cloudinary.com/dk1kmgcqn/video/upload/so_0/v1785066001/Create_an_exactly_second_HO_3_kwpfu2.jpg' },
  { title:'AI Cartoon Video 8', category:'Cartoon', src:'https://res.cloudinary.com/dk1kmgcqn/video/upload/v1785066034/Create_an_exactly_second_VE_5_abao74.mp4', poster:'https://res.cloudinary.com/dk1kmgcqn/video/upload/so_0/v1785066034/Create_an_exactly_second_VE_5_abao74.jpg' },
  { title:'AI UGC Video 1', category:'UGC', src:'https://res.cloudinary.com/dk1kmgcqn/video/upload/v1785066456/Create_a_realistic_second_v_tzv0el.mp4', poster:'https://res.cloudinary.com/dk1kmgcqn/video/upload/so_0/v1785066456/Create_a_realistic_second_v_tzv0el.jpg' },
  { title:'AI UGC Video 2', category:'UGC', src:'https://res.cloudinary.com/dk1kmgcqn/video/upload/v1785066462/Continue_with_the_same_farmer__1_ipzzwz.mp4', poster:'https://res.cloudinary.com/dk1kmgcqn/video/upload/so_0/v1785066462/Continue_with_the_same_farmer__1_ipzzwz.jpg' },
  { title:'AI UGC Video 3', category:'UGC', src:'https://res.cloudinary.com/dk1kmgcqn/video/upload/v1785066601/Create_a_second_vertical__mtri4z.mp4', poster:'https://res.cloudinary.com/dk1kmgcqn/video/upload/so_0/v1785066601/Create_a_second_vertical__mtri4z.jpg' },
  { title:'AI UGC Video 4', category:'UGC', src:'https://res.cloudinary.com/dk1kmgcqn/video/upload/v1785066608/WEBSITE_SCREEN_INSERT___USE_ON_hetwsv.mp4', poster:'https://res.cloudinary.com/dk1kmgcqn/video/upload/so_0/v1785066608/WEBSITE_SCREEN_INSERT___USE_ON_hetwsv.jpg' },
  { title:'AI UGC Video 5', category:'UGC', src:'https://res.cloudinary.com/dk1kmgcqn/video/upload/v1785066615/Create_a_realistic_second_v_1_doyizs.mp4', poster:'https://res.cloudinary.com/dk1kmgcqn/video/upload/so_0/v1785066615/Create_a_realistic_second_v_1_doyizs.jpg' }
];
